...
Observations :
    ...
    Difference from code_3: adds interaction upon every segmentation, asking 
    for category.

    Implemented search and exploration interaction.
...
def search_mode(sgng, dictionary, img, max_indices):
...
\'exploration\' to return to exploration mode.)\n')
    ...
    # Finding number of salient points
    n = max_indices[0].shape[0]
            ...
            if (moving == 0) and (waiting_input == 0):
                ...
                for i in range(n):
                    ...
                    if img_parcial is not None:
                        ...
                        if answer == 'search':
                            search_mode(sgng, dictionary, img, max_indices)
