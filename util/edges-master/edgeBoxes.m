...
% felipe
%addpath(genpath('/mnt/home/felipe/Documents/Faculdade/mestrado/projeto/codigo/edges-master/toolbox/')); savepath;
...
dfs={'name','', 'alpha',.35, 'beta',.75, 'eta',1, 'minScore',.01, ...
  'maxBoxes',100, 'edgeMinMag',.1, 'edgeMergeThr',.5,'clusterMinMag',.5,...
  'maxAspectRatio',3, 'minBoxArea',5000, 'gamma',2, 'kappa',1.5 };
